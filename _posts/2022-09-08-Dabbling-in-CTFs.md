...
![A gif showing the memory fields for the inputs 'p', 'pi', 'pic' and 'pico' respectively. The checksums for 'p' and 'pic' have the right characters, but are in the wrong order.](/blog/assets/sar-5.gif)
